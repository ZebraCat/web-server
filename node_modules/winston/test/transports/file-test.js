...
vows.describe('winston/transports/file').addBatch({
  ...
  "Error object in metadata #610": {
    topic: function () {
      ...
      fileTransport.log('info', 'tests message', myErr, this.callback.bind(this, null, myErr));
    },
  ...
  "Date object in metadata": {
    topic: function () {
      ...
      fileTransport.log('info', 'tests message', obj, this.callback.bind(this, null, obj));
    },
