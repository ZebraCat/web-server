  ...
  return {
    topic: function () {
      ...
      transport.on('error', function(emitErr){
        transport.log('error', 'tests message 2', {}, function(logErr, logged){
          self.callback(emitErr, logErr);
        });
      });
      transport.log('error', 'tests message');
    },
...
helpers.testLevels = function (levels, transport, assertMsg, assertFn) {
  ...
  Object.keys(levels).forEach(function (level) {
    var test = {
      topic: function () {
        transport.log(level, 'tests message', {}, this.callback.bind(this, null));
      }
    };
  ...
  var metadatatest = {
    topic: function () {
      transport.log('info', 'tests message', { metadata: true }, this.callback.bind(this, null));
    }
  };
  ...
  var primmetadatatest = {
    topic: function () {
      transport.log('info', 'tests message', 'metadata', this.callback.bind(this, null));
    }
  };
  ...
  var circmetadatatest = {
    topic: function () {
      transport.log('info', 'tests message', circmetadata, this.callback.bind(this, null));
    }
  };
