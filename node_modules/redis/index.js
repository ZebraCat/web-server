...
RedisClient.prototype.create_stream = function () {
    ...
    /* istanbul ignore next: difficult to tests and not important as long as we keep this listener */
...
RedisClient.prototype.on_info_cmd = function (err, res) {
    ...
    /* istanbul ignore if: some servers might not respond with any info data. This is just a safety check that is difficult to tests */
    if (!res) {
